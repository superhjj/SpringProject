...
public class MemberServiceImpl implements MemberService {
	...
	/*
	 * memberSearch member�� ID�� pwd�� �Ű������� �Ѱ��ش�.
	 */
	@Override
	...
	/*
	 * memberIdSearch member�� mail�� Id�� �˻��Ѵ�.
	 */
	@Override
	...
	/*
	 * memberPwdSearch member�� ID�� Mail�� ������ ���� �Ű������� �Ѱܾ� �Ѵ�.
	 */
	@Override
	...
	public String memberRegistSeller(String wrkrRegNo, String repName) {
		...
		try {
			...
			urlBuilder.append("&" + URLEncoder.encode("wrkrRegNo", "UTF-8") + "="
					+ URLEncoder.encode(wrkrRegNo, "UTF-8")); /* ����ڵ�Ϲ�ȣ */
			...
			System.out.println("member register seller ����");
			e.printStackTrace();
